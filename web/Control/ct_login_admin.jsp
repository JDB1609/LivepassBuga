...
<%
  ...
  try {
    ...
    if (opt.isEmpty()) {
      ...
      request.getRequestDispatcher("../Vista/Login_admin.jsp").forward(request, response);
      return;
    }
    ...
    // Redirige directamente al panel administrativo
    String ctx = request.getContextPath();
    response.sendRedirect(ctx + "/Vista/DashboardAdministrador.jsp");
